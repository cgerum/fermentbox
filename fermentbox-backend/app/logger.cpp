...
class Logger {
    ...
    void do_log(){
        ...
        current_entry.current_temp = current_measurement.temperature * LOG_SCALE_FACTOR;
        current_entry.current_humidity = current_measurement.humidity * LOG_SCALE_FACTOR; 

        current_entry.target_temp = control_state.target_temperature * LOG_SCALE_FACTOR;
        current_entry.target_humidity = control_state.target_humidity * LOG_SCALE_FACTOR;
    ...
    void run(){
        ...
        timer.initializeMs(1000*LOG_INTERVALL, TimerDelegate(&Logger::do_log, this)).start();
    }
